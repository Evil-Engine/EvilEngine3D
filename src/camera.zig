...
pub const Camera = struct {
    ...
    pub fn updateMatrix(self: *Camera, width: f32, height: f32, fovDeg: f32, nearPlane: f32, farPlane: f32) void {
        ...
        cglm.glmc_perspective(cglm.glm_rad(fovDeg), @as(f32, @divFloor(width, height)), nearPlane, farPlane, &projection[0]);
